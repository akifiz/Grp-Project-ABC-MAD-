        ...
        builder: (BuildContext context) {
          ...
          return StatefulBuilder(builder: (context, setState) {
            ...
            bool validateParticipant(){
              List<String> participants = participantControllers.map((controller) => controller.text).toList();
                  ...
                  onPressed: () {
                    if (validateTitle() && validateParticipant()) {
                      ...
                      for(var i = 0; i < participantControllers.length; i++){
                        initialBalances.add(createRepeatingPattern("0,", participantControllers.length));
                      }
                      ...
                      _addEvent(new Event(
                        ...
                        userId: participantControllers.map((controller) => controller.text).toList(),
                      ));
